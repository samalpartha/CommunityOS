...
exports.syncResourcesDaily = void 0;
 ...
 */
exports.syncResourcesDaily = functions.pubsub
    ...
    try {
        ...
        const PLACES_API_KEY = (_a = functions.config().google) === null || _a === void 0 ? void 0 : _a.places_api_key;
        if (!PLACES_API_KEY) {
        ...
        for (const city of cities) {
            ...
            for (const resType of resourceTypes) {
                const places = await fetchPlacesFromAPI(city.lat, city.lng, resType.placeType, resType.keywords, PLACES_API_KEY);
                // Save to Firestore
 ...
 */
async function fetchPlacesFromAPI(lat, lng, placeType, keywords, apiKey) {
 ...
 */
function convertToResource(place, resourceType, cityId) {
    var _a;
    const descriptions = {
    ...
    return {
        ...
        contact: {
            ...
            hours: ((_a = place.opening_hours) === null || _a === void 0 ? void 0 : _a.open_now) ? 'Open now' : 'Check hours'
        },
...
//# sourceMappingURL=syncPlaces.js.map